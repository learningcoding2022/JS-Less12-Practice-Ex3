...
const getRegistrationData = async function () {
    ...
    //Parse the JSON data from the request and save it to a variable named data
    const data = await request.json();
    console.log(data);
    displayContactList(data);
}

//Create a function expression called displayContactList with data as a parameter.
//Inside the function, loop over the data.
//For every student who hasn’t registered, create a new list element that will contain their name.
//Append the list item to the notRegistered element.
